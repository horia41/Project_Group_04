...
def create_train_test_split(): # Renamed function
    ...
    # -------- 2019 -> train/test (stratified 75/25 split) --------
    print(f"Processing 2019 -> train/test ({int(TRAIN_SPLIT*100)}% / {int((1-TRAIN_SPLIT)*100)}%)")
    ...
    print(f"\n2019 -> train/test ({int(100*TRAIN_SPLIT)}%/{int(100*(1-TRAIN_SPLIT))}%) split.")
