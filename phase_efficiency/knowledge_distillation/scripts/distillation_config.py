...
# Teacher model paths
TEACHER_MODELS = {
    'default': '../phase_performance_hybrids/results_model_saves_resnet50_cswin/results_from_model_v2_heavy_augmentation/threshold_0.07_hybridv2_Tr2019_Te2022.pth',
