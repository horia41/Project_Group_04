...
def fine_tune_model(model_name, trainloader, testloader, num_classes, epochs=15):
    ...
    # save model
    save_folder = '../phase_performance_baselines/model_saves'
    model_save_path = os.path.join(save_folder, 'resnet50_deepTL_100epochs_runX.pth')  # or VGG11_deepTL_100epochs_runX.pth
...
def evaluate_stats(net, testloader):
    ...
    total = 0    # Python ints (avoid in case of MPS usage, float64 issues)
    correct = 0
